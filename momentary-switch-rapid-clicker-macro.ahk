; Momentary Switch Rapid Clicker Macro V2.0
...
; A directive for the script to require AutoHotkey 2.0
...
;   Recommended values are 5 or 10. It's a good balance between speed and CPU usage
;   Okay values range from 1 and above
;   UNRECOMMENDED values are 0 and -1 as it can significantly increase CPU usage
...
OnUserLeftMouseButtonPress(*)
{
    ...
    while GetKeyState("LButton", "P")
    {
        ...
        ; Wait for the configured interval between clicks to avoid overwhelming inputs.
